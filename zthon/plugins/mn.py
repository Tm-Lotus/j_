...
ZelzalDV_cmd = (
    "𓆩 [SOURCE_ALPOP  - بوت تحميل الافلام والمسلسلات من اليوتيوب](t.me/SOURCE_ALPOP) 𓆪\n\n"
    "⪼ يوزر بوت تحميل مسلسلات وافلام من اليوتيوب\n"
    "⪼ 𓅱 𝐔𝐒𝐄𝐑 @VIP_ALPOP\n"
    "\n𓆩 [𐇮 𝐀𝐋 𝐏𝐎𝐏  • 𐇮](t.me/SOURCE_ALPOP) 𓆪"
)
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝐀𝐋 𝐏𝐎𝐏 :**\n\n"
