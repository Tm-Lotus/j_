...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏 ‌‌ 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامر جديده🎸](t.me/SOURCE_ALPOP‌‌) .\n\n**⎉اليك عزيزي الاوامر الجديده :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏 ‌‌ 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامر جايه 🎸](t.me/SOURCE_ALPOP‌‌) .
**- الامـر :**
**⪼** `.سينزر تاج راسك`
...
async def _(event):
    await event.edit(
        """[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏 ‌‌ 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/SOURCE_ALPOP‌‌) .
**- الامـر :**
**⪼** `.حذف فار رسائلي`
**⪼** `.مسح`
