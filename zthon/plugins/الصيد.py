...
ZelzalChecler_cmd = (
    ...
    "𓆩 [ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏 ‌- أوامـر الصيد والتشيكـر](t.me/SOURCE_ALPOP) 𓆪\n\n"
    ...
    "**- انضـم للقنـاة ~ @SOURCE_ALPOP**\n"

    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن البوب**\n\n"
...
"𓆩 [ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏 ‌ - أنـواع اليـوزرات](t.me/SOURCE_ALPOP) 𓆪\n\n"

"**✾╎قـائمـة أنـواع اليـوزرات التي يمكـن صيدهـا مـع الأمثـلة :** \n\n"

"⪼  `.صيد ثلاثيات`  **مثـال ~** j_s_9\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد البوب alpop ⎉",

                    about="This channel to hunt username by - @SOURCE_ALPOP ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                title="⎉ تثبيت البوب alpop ⎉",

                about="تم تثبيت اليـوزر بواسطـة سـورس البوب - @SOURCE_ALPOP ",
