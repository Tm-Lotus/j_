...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏 ‌   **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 956893993 or event.chat_id == 5964879906 or event.chat_id == 5964879906 or event.chat_id == 956893993:
...
async def approve_p_m(event):
    ...
    await edit_or_reply(
        ...
        caption="𝐀𝐋 𝐏𝐎𝐏  المسمـوح لهـم ( المقبوليـن )**\n\n**- سـورس البوب** 𝐀𝐋 𝐏𝐎𝐏  ",
    )
