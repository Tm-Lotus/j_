...
ZelzalDV_cmd = (
    "𓆩 [𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏 ‌𓆪 - اوامر بوت استخراج الجلسات](t.me/source_alpop) 𓆪\n\n"
    "⪼ بوت استخراج جلسات الخاص بسورس البوب \n"
    "⪼(@B_0_T_BOT)n"
    "⪼برعاية المطورين @VIP_ALPOP @j_s_9  \n" 
    "⪼ ⪼  برعاية المطور البوب يبلف\n"
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت البوب انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن بوت البوب :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت البوب انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
