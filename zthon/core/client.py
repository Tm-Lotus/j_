                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @j_S_9 @vip_alpop \
                                  \n\n--------بـدء تتبـع سجـل البوب ------\
                        ...
                        link = "[alpop(https://t.me/vip_alpop )"
                        text = (
                            "**✘ تقـريـر إشعـار البوب  ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار البوب **\n\n "
                        link = "[ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏 ‌ (https://t.me/source_alpop )"
