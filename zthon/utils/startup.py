...
async def startupmessage():
    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph//file/372ae553b567e2bee1573.png",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس تيبثـون الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐋𝐏𝐎𝐏", "https://t.me/source_alpop"),)],
    ...
    try:
        ...
        if msg_details:
            ...
            text = message.text + "\n\n**•⎆┊تـم إعـادة تشغيـل السـورس البوب بنجــاح 🧸♥️**"
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        print("تم تشغيل البوت البوب بنجــاح")
        ...
        try:
            ...
            await bot.send_message("@BotFather", "source_alpop")
            ...
            await bot.send_message("@BotFather", f"- بـوت تليثون البوب المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
...
zthon = {"@source_alpop", "@Help_Leader", "@leader_VIAS", "@Leader_source", "@MA_99O"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "جروب السجل تيلثون البوب", zedub, Config.TG_BOT_USERNAME, descript, photozed
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(
            ...
            "جروب تخزين تيلثون البوب", zedub, Config.TG_BOT_USERNAME, descript, photozed

        )

        addgvar("PM_LOGGER_GROUP_ID", groupid)

        print("تم عمل الكروب التخزين البوب بنجاح واضافة الفارات اليه.")
